      ...
      <div className="sermon-popup">
        <div className="sermon-popup-container">
          ...
          <div style={{ display: "flex", width: "100%" }}>
            ...
            <p>
              ...
              {parseInt(date) == 20200410 ? (
                <a
                  className="sermonVideoRefButton"
                  href="https://j-grace.s3-us-west-2.amazonaws.com/20200410guideline.pdf"
                  target="_blank"
                >
                  안내 순서 보기
                </a>
              ...
              {videoAttachmentExist && (
                <button
                  className="sermonVideoRefButton"
                  onClick={() => setShowVideoAttachment(true)}
                >
                  첨부 동영상 보기
                </button>
              )}
          ...
          <audio style={{ outline: "none" }} controls>
            <source
              src={`https://j-grace.s3-us-west-2.amazonaws.com/${date}.mp3`}
              type="audio/mp3"
            />
          </audio>
        </div>
